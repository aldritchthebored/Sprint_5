...
class TestStellarBurgers:
    def test_registration_new_user(self, driver):
        ...
        driver.find_element(By.XPATH, '//*[@id="root"]/div/main/div/form/fieldset[1]/div/div/input').send_keys('Алексей')
        driver.find_element(By.XPATH, '//*[@id="root"]/div/main/div/form/fieldset[2]/div/div/input').send_keys('xxxxxxxx@ya.ru')
